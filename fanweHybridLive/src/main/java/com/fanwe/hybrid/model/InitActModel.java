...
public class InitActModel extends BaseActModel
{
    ...
    private String run_light_text;//直播间跑马灯
    private String service_jump_url;//APP首页客服
    private int open_invite; //1：打开邀请功能
    private int invite_is_mandatory;//邀请码必填
    ...
    public String getRun_light_text() {
        return run_light_text;
    }

    public void setRun_light_text(String run_light_text) {
        this.run_light_text = run_light_text;
    }

    public String getService_jump_url() {
        return service_jump_url;
    }

    public void setService_jump_url(String service_jump_url) {
        this.service_jump_url = service_jump_url;
    }
    ...
    public void setOpen_invite(int open_invite) {
        this.open_invite = open_invite;
    }

    public int getInvite_is_mandatory() {
        return invite_is_mandatory;
    }

    public void setInvite_is_mandatory(int invite_is_mandatory) {
        this.invite_is_mandatory = invite_is_mandatory;
    }
}
