...
public class ApkConstant
{
     ...
     * aeskey
     */
    public static final String AES_KEY = TextUtils.isEmpty(BuildConfig.app_id_tencent_live)? App.getApplication().getString(R.string.app_id_tencent_live) + "000000" :BuildConfig.app_id_tencent_live + "000000";
