...
public class LivePushViewerActivity extends LiveLayoutViewerExtendActivity implements LivePlayerSDK.TPlayCallback
{
    ...
    protected boolean validatePlayUrl(String playUrl)
    {
        ...
        {//&& playUrl.contains(".flv")
            getPlayer().setPlayType(getVodType(playUrl));
        } else
        {
    ...
    {
        super.sdkPauseVideo();
        Log.e("sdkPauseVideo","sdkPauseVideo");
        getPlayer().stopPlay();
    }
    ...
    protected void sdkResumeVideo()
    {
        ...
        Log.e("sdkResumeVideo","sdkResumeVideo");
        getPlayer().startPlay();
    }
    ...
    protected void sdkStopLinkMic()
    {
        ...
        Log.e("sdkStopLinkMic","sdkStopLinkMic");
        stopLinkMic(false, true);
    }
    ...
    {
        Log.e("onEventMainThread","onEventMainThread2");
        getPlayer().startPlay();
    }
