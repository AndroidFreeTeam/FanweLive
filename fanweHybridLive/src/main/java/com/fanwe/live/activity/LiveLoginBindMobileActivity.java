...
public class LiveLoginBindMobileActivity extends LiveMobileBindActivity
{
    ...
    {
        CommonInterface.requestMobileLogin(strMobile, code, invite_code,mLoginType, mOpenid, mAccessToken, new AppRequestCallback<App_ProfitBindingActModel>()
        {
            @Override
    ...
    protected void requestOnSuccess(App_ProfitBindingActModel actModel)
    {
        ...
        {
            InitBusiness.startMainActivity(LiveLoginBindMobileActivity.this);
        }
    }
}
