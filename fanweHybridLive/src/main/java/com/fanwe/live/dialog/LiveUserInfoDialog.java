...
public class LiveUserInfoDialog extends LiveBaseDialog
{
    ...
    @ViewInject(R.id.btn_forbid_msg)
    private Button btn_forbid_msg;

    private String to_user_id;

    private String db_user_id;

    private int db_user_level;
    ...
    private void init_id(String user_id)
    {
        ...
        if (user != null)
        {
            ...
            this.db_user_level = user.getUser_level();
        } else
        {
    ...
    private void register()
    {
        ...
        btn_forbid_msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(null != app_userinfoActModel){
                    showForbidTimeDialog(app_userinfoActModel.getIs_forbid());
                }
            }
        });
    }
    ...
    private void bindData(App_userinfoActModel actModel)
    {
        ...
        if (to_user != null)
        {
            ...
            SDViewBinder.setTextView(tv_city, to_user.getCity(), "武汉");
        ...
        if(actModel.getIs_forbid() == 1){
            btn_forbid_msg.setText("取消禁言");
        }else{
            btn_forbid_msg.setText("禁言");
        }
        // 如果不是超级管理员
        if (!TextUtils.isEmpty(to_user_id) && !to_user_id.equals(db_user_id) && db_user_level == 353){
            SDViewUtil.setVisibleOrGone(btn_forbid_msg, true);
        }else{
            SDViewUtil.setVisibleOrGone(btn_forbid_msg, false);
        }
    }
    ...
    private void dealErrorInfo()
    {
        ...
        btn_forbid_msg.setOnClickListener(null);
