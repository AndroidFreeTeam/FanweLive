...
public class RoomInfoView extends RoomView
{
    ...
    private TextView tv_run_light_text;
    ...
    protected void init()
    {
        ...
        tv_run_light_text = find(R.id.tv_run_light_text);
        if(null != tv_run_light_text){
            InitActModel initActModel = InitActModelDao.query();
            if(null != initActModel){
                String runLightText = initActModel.getRun_light_text();
                if(null == runLightText){
                    runLightText=  "";
                }
                ViewUtil.setViewVisibleOrGone(tv_run_light_text,!TextUtils.isEmpty(runLightText));
                tv_run_light_text.setText(runLightText);
                tv_run_light_text.setSelected(true);
            }
        }
