...
public class RoomViewerBottomView extends RoomBottomView implements BankerBusiness.BankerViewerCtrlView
{
    ...
    private RoomMenuView menu_admin; //超管功能
    ...
    protected void onBaseInit()
    {
        ...
        menu_admin = (RoomMenuView) findViewById(R.id.menu_admin);
        ...
        // 超管功能
        menu_admin.setImageResId(R.drawable.ic_live_bottom_more);
        //分享
        ...
        menu_admin.setOnClickListener(this);
    ...
    public void onClick(View v)
    {
        ...
        if (clickListener != null)
        {
            ...
            } else if (v == menu_admin)
            {
                clickListener.onClickMenuAdminMsg(v);
    ...
    public void showMenuViewerAdmin(boolean show)
    {
        SDViewUtil.setVisibleOrGone(menu_admin, show);
    }
    ...
    public interface ClickListener
    {
        ...
        void onClickMenuAdminMsg(View v);
