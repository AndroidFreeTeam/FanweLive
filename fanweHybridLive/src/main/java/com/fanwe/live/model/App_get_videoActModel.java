...
public class App_get_videoActModel extends BaseActModel
{
    ...
    private int top_list_switch; // 排行榜是否显示
    ...
    public int getTop_list_switch() {
        return top_list_switch;
    }

    public void setTop_list_switch(int top_list_switch) {
        this.top_list_switch = top_list_switch;
    }
}
