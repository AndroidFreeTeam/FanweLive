...
public class UserModel implements SDSelectManager.Selectable, Serializable
{
    ...
    //座驾参数
    private String car_type="";//座驾类型
    private int is_has_car = 0;//该用户是否拥有座驾0否1是
    private String carPath = "";//该用户座驾地址
    private String car_expire_time;//用户座驾到期时间，若无座驾，则为 未开通或已过期
    private String car_name = "";//用户座驾名称
    ...
    public String getCar_expire_time() {
        return car_expire_time;
    }

    public void setCar_expire_time(String car_expire_time) {
        this.car_expire_time = car_expire_time;
    }
