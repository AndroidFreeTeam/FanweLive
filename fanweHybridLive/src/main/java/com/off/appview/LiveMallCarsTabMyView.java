 ...
 * 我的座驾
 */
public class LiveMallCarsTabMyView extends BaseAppView {
    public LiveMallCarsTabMyView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public LiveMallCarsTabMyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LiveMallCarsTabMyView(Context context) {
        super(context);
        init();
    }
...
//                svgaAnim.startAnimation();
            ...
            public void checked(int position, boolean isChecked) {
                if(isChecked){
                    CommonInterface.requestCarDef(mListModel.get(position).getId() + "", mListModel.get(position).getV_id(), new AppRequestCallback<BaseActModel>() {
                        @Override
