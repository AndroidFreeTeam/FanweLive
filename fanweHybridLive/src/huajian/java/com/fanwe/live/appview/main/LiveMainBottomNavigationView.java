 ...
 * 首页底部菜单栏
 */
public class LiveMainBottomNavigationView extends FrameLayout implements OnClickListener
{
    ...
    private void initTabs()
    {
        ...
        mTabSmallVideo.configImage()
                .setImageResIdNormal(R.drawable.ic_live_tab_shop_normal)
                .setImageResIdSelected(R.drawable.ic_live_tab_shop_selected)
                .setSelected(false);
