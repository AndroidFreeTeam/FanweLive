//package com.huite.live.adapter;
//
///**
// * Created by 沈阳汇特君交电子商务有限公司 on 2018/10/30.
// */
//
//public class LiveTabNearbyAdapter_1 {
//}
...
public class LiveTabNearbyAdapter_1 extends SDSimpleRecyclerAdapter<LiveRoomModel>
{

    public LiveTabNearbyAdapter_1(List<LiveRoomModel> listModel, Activity activity)
    {
    ...
    public void onBindData(SDRecyclerViewHolder<LiveRoomModel> holder, int position, final LiveRoomModel model)
    {
        ...
        iv_room_image.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
